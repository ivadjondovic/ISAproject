...
@Component({
  selector: 'app-new-cottage-quick-reservation',
  templateUrl: './new-cottage-quick-reservation.component.html',
  styleUrls: ['./new-cottage-quick-reservation.component.css']
})
export class NewCottageQuickReservationComponent implements OnInit {
